...
if (isset($_POST['submit'])) {
	...
	$insert_data = "INSERT INTO student_data(u_card, u_f_name, u_l_name, u_father, u_aadhar, u_birthday, u_gender, u_email, u_phone, u_state, u_dist, u_village, u_police, u_pincode, u_mother, u_family, staff_id,uploaded) VALUES ('$u_card','$u_f_name','$u_l_name','$u_father','$u_aadhar','$u_birthday','$u_gender','$u_email','$u_phone','$u_state','$u_dist','$u_village','$u_police','$u_pincode','$u_mother','$u_family','$u_staff_id',NOW())";
...
<body>
	...
	<div class="container">
		<a href="https://lexacademy.in" target="_blank"><img
				src="https://codingcush.com/uploads/logo/logo_61b79976c34f5.png" alt="" width="350px"></a><br>
		<hr>
					...
					<form method="POST" enctype="multipart/form-data">
						...
						<div class="form-row" style="color: skyblue;">
							...
							<div class="form-group col-md-6">
								...
								<input type="text" class="form-control" name="user_aadhar" maxlength="12"
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="staff_id" maxlength="12"
								placeholder="Enter 12-digit Staff Id">
						</div>
